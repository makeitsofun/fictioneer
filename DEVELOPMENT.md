...
| `admin_footer.php` | `fictioneer_classic_editor_js_restrictions` (10), `\Fictioneer\Role::hide_permalink_with_js` (10), `fictioneer_classic_editor_js_restrictions` (10)
| `admin_head` | `\Fictioneer\Role::remove_update_notice` (10), `fictioneer_output_head_fonts` (5), `\Fictioneer\Role::hide_permalink_with_css` (10), `\Fictioneer\Role::hide_inserter_media_tab_with_css` (10), `fictioneer_classic_editor_css_restrictions` (10), `fictioneer_classic_editor_css_restrictions` (10), `\Fictioneer\Role::remove_profile_blocks` (10)
