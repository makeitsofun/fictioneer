...
| `admin_init` | `fictioneer_register_settings` (10), `\Fictioneer\Role::skip_dashboard` (10), `\Fictioneer\Role::initialize_roles` (10), `fictioneer_bring_out_legacy_trash` (10), `\Fictioneer\Role::restrict_admin_panel` (10)
