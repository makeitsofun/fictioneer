...
| `admin_head` | `\Fictioneer\Role::remove_update_notice` (10), `fictioneer_output_head_fonts` (5), `fictioneer_hide_permalink_with_css` (10), `\Fictioneer\Role::hide_inserter_media_tab_with_css` (10), `fictioneer_classic_editor_css_restrictions` (10), `fictioneer_classic_editor_css_restrictions` (10), `fictioneer_remove_profile_blocks` (10)
