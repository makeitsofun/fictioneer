...
// Status
$meta_output['status'] = '<span class="story__meta-item story__status _' . strtolower( $story['status'] ) . '">' . Utils::add_class_to_element( $story['icon'], 'card-footer-icon' ) . ' ' . fictioneer_get_story_status_label( $story_id, $story['status'] ) . '</span>';
